 ...
 */
class Symfony2_Sniffs_ObjectCalisthenics_SmallClassSniff_NodeVisitor extends PHPParser_NodeVisitorAbstract
{
    /**
     * @var array
     */
    ...
    private function checkSize($node)
    {
        ...
        $this->phpcsFile
             ->addWarning(sprintf('Keep your %s small (no more than %d lines)', $keyword, $maximum), $this->findStackPointer($node));
    }
